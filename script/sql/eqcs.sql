...
-- 创建库
create database if not exists eqcs;
...
insert into sys_menu values('4', 'PLUS官网', '0', '4', 'https://gitee.com/dromara/eqc', null, '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, 'eqc官网地址');
-- 二级菜单
...
insert into sys_oss_config values (1, 'minio',  'eqc',            'eqc123',        'eqc',             '', '127.0.0.1:9000',                '','N', '',             '1' ,'0', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config values (2, 'qiniu',  'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'eqc',             '', 's3-cn-north-1.qiniucs.com',     '','N', '',             '1' ,'1', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config values (3, 'aliyun', 'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'eqc',             '', 'oss-cn-beijing.aliyuncs.com',   '','N', '',             '1' ,'1', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config values (4, 'qcloud', 'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'eqc-1250000000',  '', 'cos.ap-beijing.myqcloud.com',   '','N', 'ap-beijing',   '1' ,'1', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config values (5, 'image',  'eqc',            'eqc123',        'eqc',             'image', '127.0.0.1:9000',           '','N', '',             '1' ,'1', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
...
create table equipments (
    equipment_id        bigint(20)   not null                  comment '主键',
    ...
    department          varchar(64)            default ''      comment '所属科室',
...
create table equipment_consumables (
    consumable_id       bigint(20)   not null                 comment '主键',
    ...
    validity            int                                   comment '使用期效',
    validity_uint       varchar(16)            default ''     comment '使用期效单位',
    charge_user         bigint(20)   not null                 comment '负责人，到期后通知其更换',
    status              int                                   comment '状态 0正在使用，1已报废 2未使用过',
    create_by           varchar(64)            default ''     comment '创建者',
    create_time         datetime               default null   comment '创建时间',
    update_by           varchar(64)            default ''     comment '更新者',
    update_time         datetime               default null   comment '更新时间',
